...
export async function getAllUser() {
    ...
    if (dataRes.data == 'Invalid token') {
        ...
        for (let i = 0; i < dataRes.data.length; i++) {
            const objUser = { id: '', id_convert:'', username: '', totalValue: 0, name: '', password: '', parent_id: '',bank_name:'', bank_account_name: '', bank_account_number: '', birthday: '', city: '', district: '', sub_district: '', sex: '' };
